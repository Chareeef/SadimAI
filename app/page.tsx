...
export default function LandingPage() {
  return (
    <>
      <Header />
      <main className="flex flex-col items-center justify-center bg-gradient-to-r from-teal-300 to-teal-600 w-full min-h-dvh py-4">
        <h1 className="text-4xl font-bold text-white mb-6">
          Welcome to FastChat AI
        </h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 w-[90%]">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center p-4 bg-gradient-to-r from-teal-100 to-teal-200 rounded-lg shadow-sm">
            ...
            <div className="flex items-center p-4 bg-gradient-to-r from-blue-100 to-blue-200 rounded-lg shadow-sm">
            ...
            <div className="flex items-center p-4 bg-gradient-to-r from-purple-100 to-purple-200 rounded-lg shadow-sm">
